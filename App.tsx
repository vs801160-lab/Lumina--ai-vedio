...
const App: React.FC = () => {
  ...
  const handleBuyCredits = (credits: number) => {
    // In real app, trigger Stripe/Razorpay
    ...
    <div className="min-h-screen bg-[#080c16] text-white relative font-sans flex flex-col">
                 ...
                 <div className="flex items-center justify-between mb-6">
                    ...
                    {previousVideo && (
                      <div className="flex items-center gap-2 bg-indigo-500/20 px-3 py-1 rounded-full border border-indigo-500/30">
                        <span className="text-[10px] font-black uppercase text-indigo-400 tracking-wider">Extending Clip (+7s)</span>
                        <button onClick={() => setPreviousVideo(null)} className="hover:text-white text-indigo-400"><X size={12} /></button>
                      </div>
                    )}
                 </div>
                 <textarea 
        ...
        {currentView === 'library' && (
           <div className="animate-in slide-in-from-bottom duration-700">
             <div className="flex items-center justify-between mb-12">
               <h2 className="text-4xl font-black">Project Vault</h2>
             </div>
             {library.length === 0 ? (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 backdrop-blur-md bg-black/60">
           <div className="bg-slate-900 border border-slate-800 w-full max-w-5xl rounded-[3rem] p-10 relative overflow-hidden animate-in zoom-in-95 duration-300">
              ...
              <div className="text-center mb-12">
                 <h3 className="text-4xl font-black mb-2">{t.pricingTitle}</h3>
      ...
      <footer className="border-t border-slate-800 bg-[#080c16] py-12 px-6 mt-20">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3 font-black tracking-tighter">LUMINA AI VIDEO PRO</div>
          <div className="flex items-center gap-8 text-xs font-bold text-slate-500">
            <button onClick={() => setCurrentView('privacy')} className="hover:text-indigo-400">Privacy</button>
            <button onClick={() => setCurrentView('terms')} className="hover:text-indigo-400">Terms</button>
