...
class SupabaseService {
  ...
  constructor() {
    if (SUPABASE_URL && SUPABASE_ANON_KEY && !SUPABASE_URL.includes('your-project')) {
      ...
      console.warn("Supabase not configured. Check your environment variables.");
    }
  }
  ...
  async signInWithGoogle() {
    if (!this.isConfigured) {
      console.log("Using Mock Login (No Supabase Keys found)");
    ...
    // Explicitly define redirect URL for Firebase
